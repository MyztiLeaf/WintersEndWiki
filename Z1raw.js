...
|title=
Conduit Reliquary (Z1)
|id=Conduit Reliquary is an overrun with nature of green and rose that protects the cryobloom power tower. That locks any creature but thing slips out.
|background=resource/regions/z1.png
}}

{{Infobox-regions
|Name=Conduit Reliquary
|thumbnail=resource.png
|Region Acronym=Z1
|Creator=Myztileaf
|ROOMS (SCREENS)=46(108)
|Shelters=4
|Subregions=NaturePath, Conduit Reliquary
|Region Connections=["Z1->Z2"]
}}

{{Contents|list=
<ol>
    <li><a href="#overview">Overview</a></li>
    <li><a href="#subregions">Subregions</a>
        <ol class="sub-list">
            <li><a href="#naturepath">NaturePath</a></li>
            <li><a href="#conduit-reliquary">Conduit Reliquary</a></li>
        </ol>
    </li>
    <li><a href="#creatures">Creatures</a></li>
    <li><a href="#point-of-interest">Point of Interest</a></li>
    <li><a href="#tips">Tips</a></li>
    <li><a href="#gallery">Gallery</a></li>
    <li><a href="#arena-mode-unlockables">Arena Mode Unlockables</a></li>
    <li><a href="#trivia">Trivia</a></li>
    <li><a href="#spoilers">Spoilers</a></li>
    <li><a href="#region-map">Region Map</a></li>
</ol>
}}
== Overview ==
...
=== NaturePath ===
'''NaturePath''' is the side of the wall where wall of the power station is, overrun by the nature of green and roses. It has a bridge leading to the Conduit Reliquary.
...
== Tips ==
* Watch out for aggressive creatures in the power station areas
* Shelters are limited, very linear path.

== Gallery ==
<div class="gallery-grid">
    <div class="gallery-item">
        <div class="gallery-image-container">
            <img src="resource/regions/z1_a09.png" alt="z1_a09">
        </div>
        <div class="gallery-caption">z1_a09 (NaturePath)</div>
    </div>
    <div class="gallery-item">
        <div class="gallery-image-container">
            <img src="resource/regions/z1_c04.png" alt="z1_c04">
        </div>
        <div class="gallery-caption">z1_c04 (Conduit Reliquary)</div>
    </div>
</div>

== Arena Mode Unlockables ==
There is no Arena Mode Unlockables, Wait till expansion.

== Trivia ==
subregion name NaturePath is referenced from HK (GreenPath)

{{Spoiler|header=SPOILER WARNING|warning=This section contains spoilers for the region's lore.|content=
In Z1, The player stands in the middle to activate the secret music note, Referenced to Sky: Children of the Light, but the author haven't tried playing because of potato pc.
}}
